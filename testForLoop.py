...
msfile = ['./para1-1.txt', './para1-2.txt', './para2-1.txt', './para2-2.txt']
sequencefile = ['./data-1.txt', './data-1.txt', './data2.txt', './data2.txt']
outputfile = ['./output1-1.txt', './output1-2.txt', './output2-1.txt', './output2-2.txt']
index = 0
rest = 0
